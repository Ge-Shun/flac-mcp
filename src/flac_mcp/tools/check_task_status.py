...
from flac_mcp.formatting import (
    build_bridge_error,
    build_operation_error,
    format_unix_timestamp,
    paginate_output,
)
from flac_mcp.utils import FilterText, OutputLimit, SkipNewestLines, TaskId, WaitSeconds


def register(mcp: FastMCP) -> None:
    """Register flac_check_task_status tool."""

    @mcp.tool()
    async def flac_check_task_status(
        task_id: TaskId,
