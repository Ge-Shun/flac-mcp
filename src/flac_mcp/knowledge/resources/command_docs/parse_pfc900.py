...
Usage:
    uv run python src/flac_mcp/knowledge/resources/command_docs/parse_pfc900.py
"""
...
COMMANDS_DIR = Path("C:/Dev/Han/pfc-mcp/src/flac_mcp/knowledge/resources/command_docs/commands")
